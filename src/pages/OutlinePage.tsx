  ...
  return (
    <div className=" bg-[#E7E7E7]">
      ...
      <div className="flex flex-col items-center justify-center text-center my-10">
        <div className="w-[340px] h-[111px] rounded-b-[20px] bg-[#FAFAFA] shadow-[0px_0px_6px_0px_rgba(0,0,0,0.10)] ">
          <p>
            SAHMYOOK UNIV.FESTIVAL <br />
            &lt;AGAIN, YOUTH!&gt;
          </p>
        </div>
        <div className="w-[340px] h-[278px] rounded-[20px] bg-[#FAFAFA] shadow-[0px_0px_6px_0px_rgba(0,0,0,0.10)]">
        ...
        <div className="w-[340px] h-[292px] rounded-[20px] bg-[#FAFAFA] shadow-[0px_0px_6px_0px_rgba(0,0,0,0.10)]">
