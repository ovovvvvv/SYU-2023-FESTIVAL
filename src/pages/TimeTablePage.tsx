  ...
  return (
    <div className="bg-timetable h-screen">
      <div className="flex flex-col justify-center items-center ">
        ...
        <div className="flex items-center justify-center text-sm w-[342px] h-[38px] rounded-t-lg bg-black text-[#fff]">
          부스 시간표
        </div>
        <div className="w-[340px] h-[226px] flex flex-col justify-center bg-[#FAFAFA] rounded-b-lg">
        ...
        <div className="flex items-center justify-center text-sm w-[342px] h-[38px] mt-5 rounded-t-lg bg-black text-[#fff]">
          행사 진행 순서
        </div>
        <div className="w-[340px] h-[430px] flex flex-col justify-center bg-[#FAFAFA] rounded-b-lg">
