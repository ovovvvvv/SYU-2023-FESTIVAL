const OutlinedDetail = () => {
  return (
    <div>
      <div className="flex flex-col items-center justify-center">
        <div
          className="flex flex-col py-6 text-[#fff] text-start text-[15px] border-[0.6px] border-[#eeeeee] w-[300px] backdrop-blur-[75px] bg-gradient-to-br from-[#373737] via-transparent to-[#060606] whitespace-nowrap"
          style={{
            borderRadius: '9px',
          }}
        >
